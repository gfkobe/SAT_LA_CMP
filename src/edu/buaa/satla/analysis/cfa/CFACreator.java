...
import edu.buaa.satla.analysis.cfa.CParser.FileToParse;
import edu.buaa.satla.analysis.cfa.ast.AVariableDeclaration;
...
import edu.buaa.satla.analysis.cfa.ast.c.CInitializer;
import edu.buaa.satla.analysis.cfa.ast.c.CVariableDeclaration;
import edu.buaa.satla.analysis.cfa.ast.java.JDeclaration;
import edu.buaa.satla.analysis.cfa.export.DOTBuilder;
import edu.buaa.satla.analysis.cfa.export.DOTBuilder2;
import edu.buaa.satla.analysis.cfa.export.FunctionCallDumper;
import edu.buaa.satla.analysis.cfa.model.BlankEdge;
...
import edu.buaa.satla.analysis.cfa.model.CFATerminationNode;
import edu.buaa.satla.analysis.cfa.model.FunctionEntryNode;
import edu.buaa.satla.analysis.cfa.model.c.CDeclarationEdge;
import edu.buaa.satla.analysis.cfa.model.java.JDeclarationEdge;
import edu.buaa.satla.analysis.cfa.parser.eclipse.EclipseParsers;
import edu.buaa.satla.analysis.cfa.postprocessing.function.CFADeclarationMover;
import edu.buaa.satla.analysis.cfa.postprocessing.function.CFASimplifier;
import edu.buaa.satla.analysis.cfa.postprocessing.function.CFunctionPointerResolver;
import edu.buaa.satla.analysis.cfa.postprocessing.function.ExpandFunctionPointerArrayAssignments;
import edu.buaa.satla.analysis.cfa.postprocessing.function.MultiEdgeCreator;
import edu.buaa.satla.analysis.cfa.postprocessing.function.NullPointerChecks;
import edu.buaa.satla.analysis.cfa.postprocessing.global.CFAReduction;
import edu.buaa.satla.analysis.cfa.postprocessing.global.FunctionCallUnwinder;
import edu.buaa.satla.analysis.cfa.postprocessing.global.singleloop.CFASingleLoopTransformation;
import edu.buaa.satla.analysis.cfa.types.MachineModel;
import edu.buaa.satla.analysis.cfa.types.c.CDefaults;
import edu.buaa.satla.analysis.cfa.types.c.CElaboratedType;
import edu.buaa.satla.analysis.cfa.types.c.CStorageClass;
import edu.buaa.satla.analysis.cfa.types.c.CType;
import edu.buaa.satla.analysis.cfa.types.c.CComplexType.ComplexTypeKind;
import edu.buaa.satla.analysis.core.ShutdownNotifier;
...
import edu.buaa.satla.analysis.exceptions.CParserException;
import edu.buaa.satla.analysis.exceptions.JParserException;
