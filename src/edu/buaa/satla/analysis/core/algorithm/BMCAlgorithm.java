...
import static edu.buaa.satla.analysis.core.predicate.PredicateAbstractState.FILTER_ABSTRACTION_STATES;
...
import edu.buaa.satla.analysis.core.CounterexampleInfo;
import edu.buaa.satla.analysis.core.ShutdownNotifier;
import edu.buaa.satla.analysis.core.CPAcheckerResult.Result;
import edu.buaa.satla.analysis.core.algorithm.invariants.CPAInvariantGenerator;
import edu.buaa.satla.analysis.core.algorithm.invariants.DoNothingInvariantGenerator;
import edu.buaa.satla.analysis.core.algorithm.invariants.InvariantGenerator;
import edu.buaa.satla.analysis.core.algorithm.testgen.util.ReachedSetUtils;
...
import edu.buaa.satla.analysis.core.interfaces.conditions.AdjustableConditionCPA;
import edu.buaa.satla.analysis.core.interfaces.conditions.ReachedSetAdjustingCPA;
import edu.buaa.satla.analysis.core.loopstack.LoopstackCPA;
import edu.buaa.satla.analysis.core.predicate.PredicateAbstractState;
import edu.buaa.satla.analysis.core.predicate.PredicateCPA;
import edu.buaa.satla.analysis.core.reachedset.ReachedSet;
import edu.buaa.satla.analysis.core.reachedset.ReachedSetFactory;
import edu.buaa.satla.analysis.core.reachedset.UnmodifiableReachedSet;
...
import edu.buaa.satla.analysis.util.CPAs;
import edu.buaa.satla.analysis.util.LoopStructure;
import edu.buaa.satla.analysis.util.Precisions;
import edu.buaa.satla.analysis.util.LoopStructure.Loop;
import edu.buaa.satla.analysis.util.predicates.PathChecker;
...
import edu.buaa.satla.analysis.util.predicates.pathformula.SSAMap.SSAMapBuilder;
...
public class BMCAlgorithm implements Algorithm, StatisticsProvider {
    ...
    public final boolean check() throws CPAException, InterruptedException {
      ...
      if (previousFormula != null && this.previousK == k - 1) {
        ...
        if (k <= 1) {
          ...
          unroll(reached, reachedSetInitializer);
  ...
  private boolean unroll(ReachedSet pReachedSet) throws CPAException, InterruptedException {
    adjustReachedSet(pReachedSet, new ReachedSetInitializer() {
  ...
  private boolean unroll(ReachedSet pReachedSet, ReachedSetInitializer pInitializer) throws CPAException, InterruptedException {
    adjustReachedSet(pReachedSet, pInitializer);
    return algorithm.run(pReachedSet);
  }
